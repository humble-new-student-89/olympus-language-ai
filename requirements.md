...
4. **Billing** — Android Billing Library via `in_app_purchase` plugin. No Stripe/RevenueCat. iOS will use platform-native billing when supported. Paddle for web if needed later.
